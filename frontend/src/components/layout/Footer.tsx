...
import { QUICK_LINKS, LEGAL_LINKS } from "@/lib/constants";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <Link
              href="/"
              className="text-2xl font-bold text-primary tracking-tighter block mb-6"
            >
              AXIOM
            </Link>
            <p className="text-gray-500 text-xs leading-relaxed mb-6">
              The first AI-powered real estate platform in Egypt designed for
              compatibility and trust. Find your vibe today.
            </p>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-600">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            ...
            <span className="flex items-center gap-1">
              <MapPin className="h-2.5 w-2.5" /> Cairo, Egypt
            </span>
          </div>
        </div>
      </div>
